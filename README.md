...
- **On-page overlay** — best-move arrows and an eval bar drawn directly on the captured board.
...
8. **Overlay** — Best-move arrows and an eval bar paint directly on top of the captured board; the side panel (opened manually via right-click on the toolbar icon → Open side panel) shows the same data plus full PV / settings / variation playback.
